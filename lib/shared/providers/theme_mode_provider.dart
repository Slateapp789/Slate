...
extension WorkloopAppearancePresentation on WorkloopAppearance {
  ...
  String get description => switch (this) {
    WorkloopAppearance.system => 'Match your device appearance',
    WorkloopAppearance.light => 'Always use the light appearance',
    WorkloopAppearance.dark => 'Always use the dark appearance',
  };
...
class WorkloopAppearanceNotifier extends AsyncNotifier<WorkloopAppearance> {
  ...
  Future<WorkloopAppearance> build() async {
    final stored = await ref.read(themeModeStoreProvider).read(storageKey);
