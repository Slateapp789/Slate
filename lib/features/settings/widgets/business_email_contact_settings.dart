...
class _BusinessEmailContactSettingsState
  ...
  Widget build(BuildContext context) => ListTile(
    ...
    subtitle: const Text(
      'Email and phone shown in customer emails',
      style: TextStyle(fontSize: 13, height: 1.5, color: AppColors.t2),
    ),
    ...
    child: AlertDialog(
      ...
      content: Form(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Customers will see these details in booking and payment emails. If email is blank, we use your verified account email where available. Private Apple relay addresses are not displayed.',
            ),
