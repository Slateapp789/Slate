          ...
          SafeArea(
            child: ListView(
              ...
              children: [
                ...
                const Text(
                  'Effective ${WorkloopAppInfo.legalEffectiveDate}',
                  style: TextStyle(
                    color: AppColors.t3,
                    fontSize: 13,
...
const _privacySections = <_LegalContent>[
  ...
  _LegalContent(
    ...
    'For a Workloop subscription purchased through Apple or Google, we store the store transaction reference, product, expiry, renewal or refund status and its association with your Workloop account to verify access. The store handles billing; Workloop does not receive your full payment-card details. We also keep your trial start and any lifetime beta-access grant.',
  ),
];
...
const _termsSections = <_LegalContent>[
  ...
  _LegalContent(
    ...
    'New public-launch accounts receive a free 30-day trial beginning when they first open their workspace. No payment details are required for this trial, and it does not automatically become a paid subscription. To continue after the trial, choose £14.99 per month or £149.99 per year. The store displays your local price and billing period before you confirm. Subscriptions start when purchased, renew automatically unless cancelled through the relevant store, and are subject to that store’s billing and refund rules. Deleting the Workloop app or account does not cancel an Apple or Google subscription; cancel it in your store settings. Existing beta testers keep free lifetime access linked to their Workloop account. This means access for the lifetime of the Workloop service, not a cash value or a transferable purchase. Export and account-deletion controls remain available after a trial or subscription ends. Stripe fees for collecting payments from your own customers are separate from the Workloop subscription.',
  ),
];
