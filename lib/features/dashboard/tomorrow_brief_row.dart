...
class TomorrowBriefRow extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return WorkloopListRow(
      ...
      flat: true,
      leading: const Icon(LucideIcons.sunrise, size: 24, color: AppColors.t2),
      title: const Text('Ready for tomorrow'),
      subtitle: Text(
        !matchesWorkspace
    ...
    return SizedBox(
      ...
      child: SlateSheetFrame(
        child: Column(
          ...
          children: [
            const WorkloopSheetHeader(title: 'Ready for tomorrow'),
            ...
            Expanded(
              child: !sameWorkspace || !sameUser
                  ...
                  : brief.when(
                      ...
                      data: (data) => data.bookings.isEmpty
