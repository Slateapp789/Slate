          ...
          SafeArea(
            child: LayoutBuilder(
              builder: (context, constraints) {
                final compactHeight = constraints.maxHeight < 960;
                final horizontalInset = compactHeight
                    ? AppSpacing.sm
                    : AppSpacing.sm;
                      ...
                      child: AutofillGroup(
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  TextButton(
                                    onPressed: _busy || _resendSeconds > 0
                                        ? null
                                        : () =>
                                              _submitPasswordless(resend: true),
                                    child: Text(
                                      _resendSeconds > 0
                            ...
                            const Spacer(),
                            SizedBox(height: compactHeight ? 0 : 12),
                          ],
                        ),
                      ),
                    ),
        ...
        children: [
          if (!compact)
            const Text(
              ...
              style: TextStyle(color: AppColors.t3, fontSize: 11, height: 1.25),
            ),
          Wrap(
        ...
        children: [
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const WorkloopWordmark(size: 22),
                if (!compact) ...[
                  const SizedBox(height: AppSpacing.xs),
                  const Text(
                    'Your work, in order.',
                    style: TextStyle(fontSize: 15, color: AppColors.t1),
                  ),
                  const SizedBox(height: AppSpacing.xs),
                  const Text(
