...
const _steps = [
  ...
  (
    ...
    description:
        'Your schedule, tasks and notes share this space. A booking connects a client, service and time; tasks keep follow-ups close.',
    tip: 'Create your next agreed booking, then open it when the work is done.',
  ...
  (
    destination: 'Money',
    title: 'See what came in and what is owed',
    description:
        'Record income and expenses, and follow up on unpaid work. Mark money received only when the customer has paid.',
    tip:
        'Card collection has its own business setup. A recorded balance does not move money.',
  ...
  (
    ...
    description:
        'Keep your services, prices, working hours and contact details current. Preview your booking page before sharing it with customers.',
    tip: 'Return to Getting started in Settings whenever you need a reminder.',
