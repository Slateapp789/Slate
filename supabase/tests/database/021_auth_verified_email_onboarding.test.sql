...
select set_config('request.jwt.claims',
  '{"sub":"92100000-0000-4000-8000-000000000001","role":"authenticated","aal":"aal1"}', true);
select throws_ok($$select public.complete_onboarding('Verified Test Studio','other',
...
set local role authenticated;
select set_config('request.jwt.claims',
  '{"sub":"92100000-0000-4000-8000-000000000002","role":"authenticated","aal":"aal1"}', true);
...
select set_config('request.jwt.claims',
  '{"sub":"92100000-0000-4000-8000-000000000003","role":"authenticated","aal":"aal1"}', true);
