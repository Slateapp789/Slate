...
('a2400000-0000-4000-8000-000000000001','authenticated','authenticated','route-a@example.test','',now(),now()),
('a2400000-0000-4000-8000-000000000002','authenticated','authenticated','route-b@example.test','',now(),now());
...
select set_config('request.jwt.claims','{"sub":"a2400000-0000-4000-8000-000000000001","role":"authenticated","aal":"aal1"}',true);
