...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      tester
          ...
          .onDateChanged(DateTime(2026, 9, 11));
      await tester.pumpAndSettle();
  ...
  testWidgets('non-finite prices and malformed optional emails do not submit', (
    ...
    await tester.tap(find.text('Book'));
    await tester.pumpAndSettle();
    await tester.enterText(find.widgetWithText(TextField, 'Price'), 'Infinity');
    await tester.ensureVisible(find.text('Create booking'));
    await tester.pumpAndSettle();
    expect(
      tester
    ...
    await tester.enterText(find.widgetWithText(TextField, 'Price'), '45.50');
    await tester.enterText(
      find.widgetWithText(TextField, 'Customer email'),
      'invalid-email',
    );
